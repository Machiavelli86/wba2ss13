...
public class Main {
    ...
    public static void listeRezeptnamen(ArrayList<Recipe> list) {
        int count = 1;
        ...
        for (Recipe Rezept : list) {
              System.out.println((count++) + ". " + Rezept.getTitle());
        }
    }
    
    
    public static void listeRezept(Recipe rezept) {
        
        System.out.println();
        System.out.println(rezept.getTitle());
        System.out.println("------------------------");
        System.out.println();
        
        
        ArrayList<PhotoType> fotos = (ArrayList<PhotoType>)
